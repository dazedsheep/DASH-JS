 ...
 *****************************************************************************/
 ...
 {
	_dashSourceOpen(adaptation.currentRepresentation, adaptation.mediaElement);
	//myBuffer.refill(myBuffer);
	//_dashFetchSegment(adaptation.currentRepresentation, adaptation.mediaElement);
 ...
 function onProgress(e)
 {
	...
	{
	//	console.log('DASH JS Client got progess callback... fetching next segment');
	//	_dashFetchSegment(adaptation.currentRepresentation, adaptation.mediaElement)
		overlayBuffer.bufferStateListener(overlayBuffer);
	}
